...
AddProductType(proty: ProductType){
  const headers = new HttpHeaders().set('content-type', 'application/json');
  var body = {
  ...
  return this.http.post<ProductType>(this.rootURL + '/ProductType', body, { headers });
}

EditProductType(proty: ProductType){
  ...
  return this.http.put<ProductType>(this.rootURL + '/ProductType/UpdateProductsType?product_type_id=' + proty.product_type_id, body, { headers });
}

DeleteProductType(proty: ProductType) {
  const params = new HttpParams().set('product_type_id', proty.product_type_id);
  const headers = new HttpHeaders().set('content-type', 'application/json');
  var body = {
    product_type_id : proty.product_type_id, product_type_name : proty.product_type_name, product_type_type : proty.product_type, 
  ...
  return this.http.delete<ProductType>(this.rootURL + '/ProductType/DeleteProductType?product_type_id='+ proty.product_type_id)
}
