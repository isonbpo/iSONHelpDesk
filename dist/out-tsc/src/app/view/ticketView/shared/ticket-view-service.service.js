...
let TicketViewServiceService = class TicketViewServiceService {
    constructor(fb, http) {
        this.fb = fb;
        this.http = http;
        this.rootURL = 'http://localhost:54277/api';
        this.formModelTicket = this.fb.group({
    ...
    getAllTicket() {
        return this.http.get(this.rootURL + '/ticketView/TicketList');
    }
};
TicketViewServiceService = tslib_1.__decorate([
    Injectable({
        providedIn: 'root'
    }),
    tslib_1.__metadata("design:paramtypes", [FormBuilder, HttpClient])
], TicketViewServiceService);
export { TicketViewServiceService };
//# sourceMappingURL=ticket-view-service.service.js.map